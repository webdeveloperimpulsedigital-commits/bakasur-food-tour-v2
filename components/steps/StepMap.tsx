    ...
    <div className="flex flex-col gap-5 w-full max-w-xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h2 className="text-xl sm:text-2xl font-black text-slate-900 brand-font">Global Campaign Map</h2>
        </div>

        <div className="flex items-center gap-1 px-3 py-1 rounded-full bg-blue-50 border border-blue-200 text-xs text-[#023093] font-extrabold shadow-sm">
