...
export const INITIAL_RESTAURANTS: Omit<Restaurant, 'id'>[] = [
  ...
  { name: "Hotel Ishan", description: "Sinhagad Road's popular family dining landmark famous for rich Paneer Butter Masala, Butter Naan, crispy Veg Crispy, and special Pav Bhaji.", address: "Near Anand Nagar / Manik Baug, Sinhagad Road", area: "Sinhagad Road", city: "Pune", latitude: 18.4740, longitude: 73.8210, rating: 4.8, image: "https://images.unsplash.com/photo-1589301760014-d929f3979dbc?w=800&auto=format&fit=crop&q=80", is_campaign_active: 1, total_visits: 1750, status: 'active' },
