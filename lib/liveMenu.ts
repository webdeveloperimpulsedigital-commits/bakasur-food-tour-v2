...
export const CUISINE_MENUS: CuisineProfile[] = [
  ...
  // Misal & Maharashtrian
  {
    ...
    dishes: [
      ...
      { name: "Pithla Bhakri & Thecha Thali", description: "Gram flour pithla served piping hot with freshly roasted jowar bhakri & green thecha.", price: 180, image: "https://images.unsplash.com/photo-1589301760014-d929f3979dbc?w=600&auto=format&fit=crop&q=80", popularity: 99, rating: 5.0 },
  ...
  // Chinese & Pan-Asian
  {
    ...
    dishes: [
      ...
      { name: "Crispy Veg / Chicken Manchurian Dry (8 Pcs)", description: "Golden dumplings tossed in spicy ginger, garlic, spring onions & dark soy glaze.", price: 230, image: "https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=600&auto=format&fit=crop&q=80", popularity: 98, rating: 4.9 },
      { name: "Steamed Butter Garlic Momos (6 Pcs)", description: "Handcrafted steamed Himalayan dumplings stuffed with juicy filling and chili butter.", price: 190, image: "https://images.unsplash.com/photo-1601050690597-df0568f70950?w=600&auto=format&fit=crop&q=80", popularity: 99, rating: 5.0 },
